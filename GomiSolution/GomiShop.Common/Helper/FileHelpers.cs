...
namespace Gomi.Common.Helper
{
    public class FileHelpers
    {
        ...
        public static string SaveImageFile(string commands, string fileDir, string imageName, int resize)
        {
            ...
            //DateExtensions.UtcNowTicks

            string newFile = imageName + "-" + DateExtensions.UtcNowTicks + ".jpg";
        ...
        public static string MoveFile(string objectId, string file, string currentFolder, string folderTarget, string newFileName = null)
        {
            ...
            try
            {
                ...
                {
                    newFile = FileHelpers.ProductImageName(objectId) + "." + splitImg.Last();
                }
                else
                {
                ...
                var fullPath = FileHelpers.ResourcesPath(folderTarget);
